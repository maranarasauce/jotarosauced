...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_LENGTH, dspecial_poop_window);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("SPTW"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 1000);
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 1000);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_BASE_KNOCKBACK, 0.1);
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_DSPECIAL, 1, HG_BASE_HITPAUSE, 1000);
set_hitbox_value(AT_DSPECIAL, 1, HG_EXTRA_HITPAUSE, 250);
