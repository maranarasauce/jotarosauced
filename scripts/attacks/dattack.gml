...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_TYPE, 0);
set_hitbox_value(AT_DATTACK, 1, HG_WINDOW, 2);
set_hitbox_value(AT_DATTACK, 1, HG_LIFETIME, 5);
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 106);
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -56);
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 100);
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 110);
...
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 9.5);
