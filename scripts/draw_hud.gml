if (kaky_proj == noone) {
	draw_sprite_ext(sprite_get("hud_splash_off"), 0, temp_x+182, temp_y-26, 2, 2, 0, c_white, 1);
}
else {
	draw_sprite_ext(sprite_get("hud_splash_on"), 0, temp_x+182, temp_y-26, 2, 2, 0, c_white, 1);
}

if (runeH){
	timestop_bar_xscale = (timestop_time / 300);
	draw_sprite_ext(sprite_get("hud_timestop_bar"), 0, temp_x, temp_y - 26, timestop_bar_xscale, 1, 0, c_white, 1);
}
